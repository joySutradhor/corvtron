      ...
      <div className="r__footer__conatainer">
        <div>
          <div className=" mb-[10vh]">
            <Image
              ...
              height={1000}
              width={1000}
              className="h-auto w-[10vw] object-fill"
              alt="logo"
            ></Image>
          </div>
          ...
          <button className="r__position__text">🔴 No open positions</button>
        </div>
        ...
        <div>
          <div className="">
            ...
            <div>
              <img
                src="https://cdn.prod.website-files.com/64eda916ec10005d85a2aa19/65f44430497c516db17858a4_EN_Co-fundedbytheEU_RGB_WHITE-p-800.png"
                alt="EU Flag"
                className="md:h-20 lg:h-24 my-[5vh] object-cover"
              />
            </div>
          </div>
